...
!function(ca) {
    ...
    function V(e, t, i, n) {
        return t && B(t, function(t, r) {
            !i && s(e, r) || (!n || "object" != typeof t || !t || H(t) || G(t) || t instanceof RegExp ? e[r] = t : (e[r] || (e[r] = {}),
            V(e[r], t, i, n)))
        }),
        e
    }
    ...
    function ha(e) {
        function i(e, t, i) {
            ...
            if (e && "." === e.charAt(0))
                if (t) {
                    for (r = d.slice(0, d.length - 1),
                    e = e.split("/"),
                    t = e.length - 1,
                    T.nodeIdCompat && R.test(e[t]) && (e[t] = e[t].replace(R, "")),
                    r = e = r.concat(e),
                    a = r.length,
                    t = 0; t < a; t++)
                        if ("." === (o = r[t]))
        ...
        function n(e) {
            z && v(document.getElementsByTagName("script"), function(t) {
                if (t.getAttribute("data-requiremodule") === e && t.getAttribute("data-requirecontext") === E.contextName)
        ...
        function a(e, t, n, r) {
            var a, s, u = null, c = t ? t.name : null, d = e, f = !0, p = "";
            return e || (f = !1,
            e = "_@r" + (Q += 1)),
            e = o(e),
            u = e[0],
        ...
        function u(e) {
            var t = e.id
              , i = j(D, t);
            return i || (i = D[t] = new E.Module(e)),
            i
        }
        function c(e, t, i) {
            var n = e.id
              , r = j(D, n);
            !s(A, n) || r && !r.defineEmitComplete ? (r = u(e),
            r.error && "error" === t ? i(r.error) : r.on(t, i)) : "defined" === t && i(A[n])
        }
        function d(e, t) {
        ...
        function f() {
            S.length && (ia.apply(N, [N.length, 0].concat(S)),
            S = [])
        }
        function p(e) {
            delete D[e],
        ...
        function l(e, t, i) {
            ...
            v(e.depMaps, function(n, r) {
                var o = n.id
                  , a = j(D, o);
                a && !e.depMatched[r] && !i[o] && (j(t, o) ? (e.defineDep(r, A[o]),
                e.check()) : l(a, t, i))
            }),
            i[n] = !0)
        }
        function m() {
            var e, t, i = (e = 1e3 * T.waitSeconds) && E.startTime + e < (new Date).getTime(), o = [], a = [], s = !1, u = !0;
            if (!q) {
                if (q = !0,
                B(w, function(e) {
                    var c = e.map
                      , d = c.id;
                    if (e.enabled && (c.isDefine || a.push(e),
                    !e.error))
                        if (!e.inited && i)
                            r(d) ? s = t = !0 : (o.push(d),
                            n(d));
                        else if (!e.inited && e.fetched && c.isDefine && (s = !0,
                        !c.prefix))
                            return u = !1
                }),
                i && o.length)
        ...
        return k = {
            ...
            exports: function(e) {
                if (e.usingExports = !0,
                e.map.isDefine)
                    return e.exports ? A[e.map.id] = e.exports : e.exports = A[e.map.id] = {}
            },
            module: function(e) {
        ...
        y = function(e) {
            this.events = j(L, e.id) || {},
            this.map = e,
            this.shim = j(T.shim, e.id),
            this.depExports = [],
            this.depMaps = [],
            this.depMatched = [],
            this.pluginMaps = {},
        ...
        y.prototype = {
            init: function(e, i, n, r) {
                r = r || {},
                this.inited || (this.factory = i,
                n ? this.on("error", n) : this.events.error && (n = t(this, function(e) {
                    this.emit("error", e)
                })),
                        ...
                        if (this.error)
                            ...
                            1 > this.depCount && !this.defined) {
                                if (G(r)) {
                                    ...
                                    n = r;
                                this.exports = n,
                                this.map.isDefine && !this.ignore && (A[i] = n,
                                h.onResourceLoad) && h.onResourceLoad(E, this.map, this.depMaps),
                                p(i),
                                this.defined = !0
                            }
                            this.defining = !1,
            ...
            callPlugin: function() {
                ...
                c(r, "defined", t(this, function(r) {
                    ...
                    (f = j(D, r.id)) && (this.depMaps.push(r),
                    this.events.error && f.on("error", t(this, function(e) {
                        this.emit("error", e)
                    })),
                    f.enable())) : f ? (this.map.url = E.nameToUrl(f),
                    ...
                    o.fromText = t(this, function(t, i) {
                        ...
                        f && (O = !1),
                        u(c),
                        s(T.config, n) && (T.config[r] = T.config[n]);
                        try {
                            h.exec(t)
                        } catch (e) {
            ...
            enable: function() {
                ...
                v(this.depMaps, t(this, function(e, i) {
                    var n, r;
                    if ("string" == typeof e) {
                    ...
                    n = e.id,
                    r = D[n],
                    !s(k, n) && r && !r.enabled && E.enable(e, this)
                })),
        ...
        E = {
            ...
            configure: function(e) {
                ...
                e.packages && v(e.packages, function(e) {
                    ...
                    t = e.name,
                    e.location && (T.paths[t] = e.location),
                    T.pkgs[t] = e.name + "/" + (e.main || "main").replace(ja, "").replace(R, "")
                }),
                B(D, function(e, t) {
            ...
            makeRequire: function(t, r) {
                function o(i, n, c) {
                    var f, p;
                    return r.enableBuildCallback && n && G(n) && (n.__requireJsBuild = !0),
                    "string" == typeof i ? G(n) ? d(C("requireargs", "Invalid require call"), c) : t && s(k, i) ? k[i](D[t.id]) : h.get ? h.get(E, i, t, o) : (f = a(i, t, !1, !0),
                    f = f.id,
                    s(A, f) ? A[f] : d(C("notloaded", 'Module name "' + f + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (b(),
                    E.nextTick(function() {
                        b(),
                        p = u(a(null, t)),
                        p.skipMap = r.skipMap,
                ...
                V(o, {
                    isBrowser: z,
                    toUrl: function(e) {
                        var n, r = e.lastIndexOf("."), o = e.split("/")[0];
                        return -1 !== r && ("." !== o && ".." !== o || 1 < r) && (n = e.substring(r, e.length),
                        e = e.substring(0, r)),
                        E.nameToUrl(i(e, t && t.id, !0), n, !0)
                    },
                    defined: function(e) {
            ...
            completeLoad: function(e) {
                var t, i, n = j(T.shim, e) || {}, o = n.exports;
                for (f(); N.length; ) {
                    if (i = N.shift(),
                    null === i[0]) {
                        if (i[0] = e,
                ...
                if (i = j(D, e),
                !t && !s(A, e) && i && !i.inited) {
                    if (T.enforceDefine && (!o || !ea(o)))
                        return r(e) ? void 0 : d(C("nodefine", "No define call for " + e, null, [e]));
            ...
            nameToUrl: function(e, t, i) {
                ...
                if (h.jsExtRegExp.test(e))
                    ...
                    n = ("/" === n.charAt(0) || n.match(/^[\w\+\.\-]+:/) ? "" : T.baseUrl) + n
                }
            ...
            onScriptLoad: function(e) {
                ("load" === e.type || ka.test((e.currentTarget || e.srcElement).readyState)) && (P = null,
                e = x(e),
                E.completeLoad(e.id))
            },
    ...
    if (void 0 === define) {
        ...
        void 0 !== require && !G(require) && (r = require,
        require = void 0),
        h = requirejs = function(e, t, i, n) {
            ...
            (n = j(F, o)) || (n = F[o] = h.s.newContext(o)),
            r && n.configure(r),
            n.require(e, t, i)
        }
        ,
        ...
        h.load = function(e, t, i) {
            var n = e && e.config || {};
            if (z)
                return n = h.createNode(n, t, i),
                n.setAttribute("data-requirecontext", e.contextName),
                n.setAttribute("data-requiremodule", t),
                !n.attachEvent || n.attachEvent.toString && 0 > n.attachEvent.toString().indexOf("[native code") || Z ? (n.addEventListener("load", e.onScriptLoad, !1),
                n.addEventListener("error", e.onScriptError, !1)) : (O = !0,
        ...
        define = function(e, t, i) {
            ...
            t = null),
            !t && G(i) && (t = [],
            i.length && (i.toString().replace(la, "").replace(ma, function(e, i) {
                t.push(i)
            }),
            t = (1 === i.length ? ["require"] : ["require", "exports", "module"]).concat(t))),
            O && ((n = L) || (P && "interactive" === P.readyState || U(document.getElementsByTagName("script"), function(e) {
