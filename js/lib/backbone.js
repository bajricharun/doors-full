...
!(function (t) {
  ...
  (c.off = function (t, e, i) {
    return this._events
      ? ((this._events = d(p, this._events, t, e, {
          context: i,
        ...
        for (var u = e ? [e] : i.keys(t); a < u.length; a++) {
          ...
          for (var l = [], d = 0; d < c.length; d++) {
            ...
            (o && o !== f.context)
              ...
              : (r = f.listening) &&
                0 == --r.count &&
                (delete h[r.id], delete r.listeningTo[r.objId]);
          }
          l.length ? (t[e] = l) : delete t[e];
        }
        return t;
      }
      for (var g = i.keys(h); a < g.length; a++)
        (r = h[g[a]]), delete h[r.id], delete r.listeningTo[r.objId];
    }
  };
  (c.once = function (t, e, n) {
    var s = d(v, {}, t, e, i.bind(this.off, this));
    return "string" == typeof t && null == n && (e = void 0), this.on(s, e, n);
  }),
    (c.listenToOnce = function (t, e, n) {
      var s = d(v, {}, e, n, i.bind(this.stopListening, this, t));
  ...
  i.extend(y.prototype, c, {
    ...
    set: function (t, e, n) {
      ...
      for (var d in s)
        (e = s[d]),
          ...
          r ? delete u[d] : (u[d] = e);
      if (
        (this.idAttribute in s && (this.id = this.get(this.idAttribute)), !a)
      ) {
        o.length && (this._pending = n);
        for (var f = 0; f < o.length; f++)
          this.trigger("change:" + o[f], this, u[o[f]], n);
      }
      if (h) return this;
      if (!a)
        for (; this._pending; )
    ...
    save: function (t, e, n) {
      ...
      null == t || "object" == typeof t
        ? ((s = t), (n = e))
        : ((s = {})[t] = e),
        (n = i.extend({ validate: !0, parse: !0 }, n));
      var r = n.wait;
      if (s && !r) {
      ...
      (n.success = function (t) {
        ...
        q(this, n),
        s && r && (this.attributes = i.extend({}, h, s));
    ...
    destroy: function (t) {
      ...
      return (
        this.isNew()
          ? i.defer(t.success)
          : (q(this, t), (a = this.sync("delete", this, t))),
        s || r(),
        a
      );
    },
    url: function () {
      var t =
        i.result(this, "urlRoot") || i.result(this.collection, "url") || U();
      ...
      if (null != t) {
          ...
          if (_) {
            if (f && r !== _) {
              ...
              e.parse && (y = _.parse(y, e)),
                _.set(y, e),
                u.push(_),
                v && !p && (p = _.hasChanged(m));
            }
            l[_.cid] || ((l[_.cid] = !0), o.push(_)), (t[a] = _);
          } else
            d &&
              (r = t[a] = this._prepareModel(r, e)) &&
              (h.push(r), this._addReference(r, e), (l[r.cid] = !0), o.push(r));
        }
        if (g) {
          for (a = 0; a < this.length; a++)
            (r = this.models[a]), l[r.cid] || c.push(r);
        ...
        if (
          (o.length && w
            ...
            : h.length &&
              (v && (p = !0),
              E(this.models, h, null == s ? this.length : s),
              (this.length = this.models.length)),
          ...
          for (a = 0; a < h.length; a++)
            null != s && (e.index = s + a),
              (r = h[a]),
              r.trigger("add", r, this, e);
          (p || b) && this.trigger("sort", this, e),
            (h.length || c.length || u.length) &&
              ((e.changes = { added: h, removed: c, merged: u }),
              this.trigger("update", this, e));
        }
        return n ? t[0] : t;
      }
  ...
  (R.started = !1),
    i.extend(R.prototype, c, {
      ...
      navigate: function (t, e) {
        ...
        var n = i + t;
        if (
          ((t = this.decodeFragment(t.replace(M, ""))), this.fragment !== t)
        ) {
  ...
  y.extend = b.extend = P.extend = I.extend = R.extend = O;
  var U = function () {
